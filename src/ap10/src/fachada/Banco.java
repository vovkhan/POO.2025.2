...
public class Banco {
    ...
    public void adicionarCliente(String codigo, String nome, String cep,
                                 String numero, String complemento) throws ClienteJaExisteException {
    ...
    public void adicionarConta(int tipoConta, String cpfCliente, double saldo)
            throws ClienteNaoExisteException, ContaJaExisteException, RepositorioCheioException, TipoContaNaoExisteException {
        ...
        switch (tipoConta) {
            ...
            case 2: // Tipo Poupanca
                conta = new Poupanca(cliente, saldo);
                break;
            case 3: // Tipo ContaBonificada
                conta = new ContaBonificada(cliente, saldo);
                break;
            case 4: // Tipo ContaImposto
                conta = new ContaImposto(cliente, saldo);
                break;
            default:
